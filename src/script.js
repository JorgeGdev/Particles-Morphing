...
window.addEventListener('resize', () =>
{
    ...
    // Materials
    if (particles) // SE PONE EL IF PARA EVITAR PROBLEMAS CON LOS ARCHIVOS GRANDES 
...
let particles = null  //creamos afuera de la funcion para que arreglar el problema de scoop de PARTICLES
...
gltfLoader.load("/models.glb", (gltf)=>
{
    ...
    //particles.geometry.setIndex(null) //BAJA LA CANTIDAD DE VERTICES PARA MEJORA DE PERFORMANCE

    // Material

    particles.colorA = "#004cff"
    particles.colorB = "#00ff62"
    ...
    transparent:true,
    blending: THREE.AdditiveBlending, // agranda el brillo, quita bordes
    depthWrite:false //quita el borde total
})
